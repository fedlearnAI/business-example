...
public class AccountDO implements Serializable {
    ...
    public AccountDO(String username, String password , String merCode, String roles) {
    ...
    public void setVerifyCodePic(String verifyCodePic) {
        this.verifyCodePic = verifyCodePic;
    }
}
